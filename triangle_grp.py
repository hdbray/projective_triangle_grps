...
def colored_tiling(matrices,fund_tri,affine_center,proj_matrix,choose_color='b',include_pltshow=True):
...
#   under the listed matrices
    ...
    for A in matrices:
        ...
        plt.fill(x_coordinates, y_coordinates, choose_color)
    if include_pltshow==True:
        plt.show()
